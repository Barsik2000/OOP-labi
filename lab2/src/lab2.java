...
public class lab2 {
    public static void main(String[] args) {
        ...
        point1.setX(Double.parseDouble(scan.nextLine()));
        point1.setY(Double.parseDouble(scan.nextLine()));
        point1.setZ(Double.parseDouble(scan.nextLine()));

        System.out.println("Введите координаты второй точки:");
        point2.setX(Double.parseDouble(scan.nextLine()));
        point2.setY(Double.parseDouble(scan.nextLine()));
        point2.setZ(Double.parseDouble(scan.nextLine()));

        System.out.println("Введите координаты третьей точки:");
        point3.setX(Double.parseDouble(scan.nextLine()));
        point3.setY(Double.parseDouble(scan.nextLine()));
        point3.setZ(Double.parseDouble(scan.nextLine()));
        ...
        if (point1.equalsTo(point2) || point1.equalsTo(point3) || point2.equalsTo(point3))
            System.out.println("Имеются равные точки. Площадь треугольника вычислить невозможно.");
        else
